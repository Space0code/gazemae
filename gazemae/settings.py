...
DATA_ROOT = '../data/'
GENERATED_DATA_ROOT = os.environ.get(
    'GAZEMAE_GENERATED_DATA_ROOT', '../generated-data/')
...
def get_parser():
    ...
    parser.add_argument("--corpora", default='', type=str,
                        help="Comma-separated corpora names to load "
                             "(e.g., 'ETRA2019,MIT-LowRes')")
    return parser
